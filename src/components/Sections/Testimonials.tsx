...
const Testimonials: FC = memo(() => {
  ...
  return (
    <Section noPadding sectionId={SectionId.Testimonials}>
      ...
      <div className="relative bg-nuetral-800 flex items-start text-center justify-center">
          <a
...
const Testimonial: FC<{testimonial: Testimonial; isActive: boolean}> = memo(
  ({testimonial: {text, name, jobTitle, image}, isActive}) => (
    <div
      className={classNames(
      ...
      <div className="flex flex-col gap-y-4">
        ...
        <p className="text-xs italic text-white sm:text-sm md:text-base -mt-5 lg:text-lg"> {jobTitle}</p>
      </div>
    </div>
  ),
);
