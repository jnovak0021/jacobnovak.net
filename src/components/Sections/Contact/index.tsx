...
const ContactValueMap: Record<ContactType, ContactValue> = {
  ...
  [ContactType.Instagram]: {Icon: LinkedInIcon, srLabel: 'LinkedIn'},
};
  ...
  return (
    <Section className="bg-neutral-800" sectionId={SectionId.Contact}>
      <div className='flex grid-cols-2'>
          <div className="relative h-full w-48  m-5 overflow-hidden rounded-xl">
            <Image
              alt="about-me-image"
          ...
          <div className="relative h-full w-48 overflow-hidden m-5 rounded-xl">
            <Image
              alt="about-me-image"
              className="object-cover h-full w-full"
              height={256}
